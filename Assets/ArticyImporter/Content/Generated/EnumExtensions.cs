namespace Articy.Dracula_articyXBasics
{
	...
	{
		public static string GetDisplayName(this CameraAngle aCameraAngle)
		{
			return Articy.Unity.ArticyTypeSystem.GetArticyType("CameraAngle").GetEnumValue(((int)(aCameraAngle))).DisplayName;
		}
